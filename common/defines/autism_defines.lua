...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.35, 0.20, 0.15, 0.030, 0.020 }
---Diplomacy
...
NDefines.NCountry.SPECIAL_FORCES_CAP_MIN = 9999				-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
